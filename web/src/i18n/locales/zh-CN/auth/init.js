export default {
  ...
  database: {
    tabLabel: '数据库配置',
    type: '数据库类型',
    mysqlRecommended: 'MySQL（连接时自动检测）',
    mariadbRecommended: 'MariaDB（连接时自动检测）',
    architecture: '架构',
    autoSelectHint: '连接时自动识别 MySQL/MariaDB，选择错误也会按实际服务端适配',
    autoDetectHint: '根据实际数据库服务端自动适配，与面板或浏览器架构无关；不会重置端口和密码',
    host: '数据库地址',
    port: '数据库端口',
    dbName: '数据库名称',
    username: '用户名',
