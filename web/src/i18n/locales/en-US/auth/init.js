export default {
  ...
  database: {
    ...
    type: 'Database Type',
    mysqlRecommended: 'MySQL (detected on connection)',
    mariadbRecommended: 'MariaDB (detected on connection)',
    architecture: 'Architecture',
    autoSelectHint: 'MySQL/MariaDB is detected on connection, even if the selected label is incorrect',
    autoDetectHint: 'Compatibility follows the actual database server, not the panel or browser architecture. Port and password are preserved.',
    host: 'Database Host',
    port: 'Database Port',
