export default {
  ...
  onlyLxdIncusProxmox: "Supported port mapping: LXD/Incus/Proxmox/QEMU/KubeVirt support node-side and controller forwarding; Docker/Podman/Containerd only support controller forwarding (tunnel)",
  ...
  noSupportedInstances: "No available LXD/Incus/Proxmox/QEMU/KubeVirt/Docker/Podman/Containerd instances",
  instanceNotFound: "Selected instance not found",
  dockerNotSupported: "Docker/Podman/Containerd instances only support controller port forwarding (tunnel) mode",
  dockerOnlyController: "Docker/Podman/Containerd only support controller forwarding, auto-switched",
  onlyLxdIncusProxmoxSupported: "Only supported provider types: LXD/Incus/Proxmox/QEMU/KubeVirt/Docker/Podman/Containerd",
