...
func TestIncusIPv6OnlyIsolationMasksInheritedIPv4NIC(t *testing.T) {
	command := incusIPv6OnlyIsolationCommand("guest", NetworkConfig{InSpeed: 120, OutSpeed: 80})
...
func TestIncusIPv6OnlyDNSUsesOnlyIPv6Resolvers(t *testing.T) {
	command := incusIPv6OnlyDNSCommand("guest")
