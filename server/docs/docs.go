...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/providers/{provider_id}/traffic/history": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/user/instances/{instance_id}/traffic/history": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
