    ...
    "definitions": {
        ...
        "admin.CreateProviderRequest": {
            ...
            "properties": {
                ...
                "autoAdjustQuota": {
                    "description": "是否自动调整quota以适应导入的实例",
                    "type": "boolean"
                },
                "autoImport": {
                    "description": "是否自动导入发现的实例",
                    "type": "boolean"
                },
                "city": {
                    "type": "string"
                ...
                "importedInstanceOwner": {
                    "description": "导入实例的所有者（用户名，默认\"admin\"）",
                    "type": "string"
                },
                ...
                "trafficSyncMethod": {
                    "description": "流量同步方式：pmacct(传统), agent(Rust Agent)",
                    "type": "string"
                },
                "type": {
                    "type": "string"
