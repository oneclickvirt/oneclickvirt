...
| `spiritlhl/oneclickvirt:20260414` | All-in-one version with specific date | Fixed version requirement |
| `spiritlhl/oneclickvirt:no-db` | Standalone database version | Without database |
| `spiritlhl/oneclickvirt:no-db-20260414` | Standalone database version with date | Without database |
