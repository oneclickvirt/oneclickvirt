...
| `oneclickvirt/oneclickvirt:20260724` | All-in-one version with specific date | Fixed version requirement |
| `oneclickvirt/oneclickvirt:no-db` | Standalone database version | Without database |
| `oneclickvirt/oneclickvirt:no-db-20260724` | Standalone database version with date | Without database |
